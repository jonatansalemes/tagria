...
public class AbstractElementTest {
	...
	public void htmlChain() {
		Element element = ElementCreator.newInput().attribute(Attribute.NAME, "car").attribute(Attribute.CLASS, "form-control").attribute(Attribute.CLASS,
				"required");
	...
	@Test 
	public void docType() {
		String element = ElementCreator.newDocTypeHtml5();
		Assert.assertEquals("<!DOCTYPE html>", element);
	}
}
